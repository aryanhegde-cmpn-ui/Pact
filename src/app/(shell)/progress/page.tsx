  ...
  return (
    <div className="flex flex-col gap-2xl">
      ...
      {/*
        ...
        -------------------------------------------------------------------
        The headline keeps the full width because it is the headline. Below
        it, three short sections that were each a paragraph in a 1024px
        column sit two across, and the long list -- a module a line, thirty
        of them -- runs in two columns of its own rather than a single
        ribbon down a page four screens tall.

        The list moved last for the same reason: it is the longest thing
        here and the least urgent.
      */}
      <div className="grid gap-2xl lg:grid-cols-2 lg:items-start">
        <section>
          ...
          {progress.estimateVsActual.ratio === null ? (
            ...
            <>
              <p className="text-base">
                ...
                spent against{' '}
                <span className="figures">{progress.estimateVsActual.plannedMinutes}</span>{' '}
                estimated, over{' '}
                <span className="figures">{progress.estimateVsActual.sessions}</span> sessions.
              </p>
      ...
      <section>
        ...
        <ul className="border-edge border-t lg:grid lg:grid-cols-2 lg:gap-x-2xl">
