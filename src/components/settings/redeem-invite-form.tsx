    ...
    return (
      <div className="border-edge bg-surface rounded-md border p-md">
        ...
        <button
          type="button"
          onClick={() => router.push('/')}
          className="bg-signal mt-md min-h-11 w-full rounded px-md text-sm font-medium text-[color:var(--pact-base)]"
        >
          Go to sign in
        </button>
      </div>
  ...
  return (
    <form onSubmit={submit} noValidate className="flex flex-col gap-md">
      ...
      <button
        type="submit"
        disabled={busy}
        className="bg-signal min-h-11 rounded px-md font-medium text-[color:var(--pact-base)] disabled:opacity-50"
      >
