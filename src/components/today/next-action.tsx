    ...
    >
      ...
      {interactive ? (
        <Link
          ...
          className="border-signal text-signal hover:bg-signal hover:text-base mt-lg flex min-h-14 w-full items-center justify-center rounded-md border text-base font-medium transition-colors sm:w-auto sm:px-2xl"
        >
